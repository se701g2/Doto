        ...
        <div>
            <div className="market-content-box">
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "blue", cost: themeCost.blue })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "green", cost: themeCost.green })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "gray", cost: themeCost.gray })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "magenta", cost: themeCost.magenta })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "purple", cost: themeCost.purple })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "crimson", cost: themeCost.crimson })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "red", cost: themeCost.red })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "black", cost: themeCost.black })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "darkSeaGreen", cost: themeCost.darkSeaGreen })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "antiqueWhite", cost: themeCost.antiqueWhite })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "darkKhaki", cost: themeCost.darkKhaki })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
                ...
                <div className="theme-content-box">
                    <ThemeProvider>
                        <Button
                            value={JSON.stringify({ colour: "darkSlateBlue", cost: themeCost.darkSlateBlue })}
                            onClick={event => props.handleThemeClick(event.target.value)}
                            id="color-palette"
